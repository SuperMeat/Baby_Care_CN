...
- (void)layoutSubviews
{
    ...
    _scrollView.height = self.height/2-40;
    ...
    [self.title2 setFrame:CGRectMake(0, _scrollView.origin.y+_scrollView.height, kDeviceWidth, 40)];

    _scrollView2.height = self.height/2-40;
    [_scrollView2 setFrame:CGRectMake(self.title2.origin.x, self.title2.origin.y+40,kDeviceWidth, _scrollView2.height)];
    _contentView2.height = _contentView2.optimumSize.height;
    _scrollView2.contentSize = CGSizeMake(0, _contentView2.height);
