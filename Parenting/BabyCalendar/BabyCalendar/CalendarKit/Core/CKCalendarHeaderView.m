...
//            
//            CGRect frame = CGRectMake(i*labelWidth, ([self frame].size.height-labelHeight)/2, labelWidth, labelHeight);
//            [label setFrame:frame];
//            
//            [self addSubview:label];
//        }
        UIImageView* bg_week = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kDeviceWidth, 24)];
        [bg_week setImage:[UIImage imageNamed:@"calendar_headView"]];
        [self addSubview:bg_week];
    }
}
